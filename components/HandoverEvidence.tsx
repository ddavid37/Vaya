// Placeholder + manual evidence panels for overage disputes (handwriting, scans, insurance).
  ...
  return (
    <div className="mt-10 flex flex-col gap-8">
      ...
      <section className="border border-rule p-5">
        ...
        <p className="mt-2 max-w-2xl text-[0.8rem] leading-relaxed font-light text-muted">
          Placeholder for before/after condition scans (damage timing). Not
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <label className="flex flex-col gap-1.5">
            ...
            <button
              type="button"
              onClick={() =>
                setScanBefore(`Captured placeholder @ ${new Date().toISOString().slice(0, 16)}Z`)
              }
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <button
              type="button"
              onClick={() =>
                setScanAfter(`Captured placeholder @ ${new Date().toISOString().slice(0, 16)}Z`)
              }
              className="mt-1 w-fit border border-rule-s px-2 py-1 font-mono text-[0.6rem] tracking-[0.12em] text-mid uppercase hover:border-orange hover:text-orange"
            >
              Mark after scan
